...
<svelte:head>
  <title>Dashboard - LMS IDEA</title>
</svelte:head>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          <div class="flex items-center">
            ...
            <h1 class="text-xl font-semibold text-gray-900">LMS IDEA</h1>
          </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              ...
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  <div class="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                      <p class="text-sm font-semibold text-gray-900 group-hover:text-blue-700 transition-colors">{classItem.name}</p>
                      <p class="text-xs text-gray-600">{classItem.description || 'No description'}</p>
                    </div>
                  </div>
      ...
      {:else}
        <div class="text-center py-12">
          ...
          <p class="text-sm text-gray-500 mb-6">Join a class to get started with your learning journey.</p>
          <Button variant="primary" size="md" on:click={() => goto('/classes')}>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
      <div class="flex justify-between items-center mb-6">
        <div class="flex items-center space-x-3">
          ...
          <h3 class="text-xl font-semibold text-gray-900">Recent Assignments</h3>
        </div>
        {#if exercises.length > 0}
          <Button variant="secondary" size="sm" on:click={() => goto('/assignments')}>
            View All
          </Button>
        {/if}
      </div>
      {#if exercises.length > 0}
        <div class="space-y-4">
          {#each exercises.slice(0, 3) as exercise}
            <button 
              class="w-full group bg-gradient-to-r from-orange-50 to-red-50 rounded-xl border border-orange-200 p-4 hover:from-orange-100 hover:to-red-100 hover:border-orange-300 hover:shadow-md transition-all duration-200 text-left"
              ...
              <div class="flex items-center justify-between">
                <div class="flex-1">
                  <div class="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                      <p class="text-sm font-semibold text-gray-900 group-hover:text-orange-700 transition-colors">{exercise.title}</p>
                  ...
                  <div class="flex items-center space-x-4 text-xs text-gray-500">
                    <div class="flex items-center space-x-1">
                      ...
                      <span>{exercise.class?.name || 'Unknown Class'}</span>
                    </div>
                    {#if exercise.dueDate}
                      <div class="flex items-center space-x-1">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {#if exercises.length > 3}
            <div class="text-center pt-2">
              <Button variant="secondary" size="sm" on:click={() => goto('/assignments')}>
                View All Assignments ({exercises.length})
              </Button>
            </div>
          {/if}
        </div>
      {:else}
        <div class="text-center py-12">
          ...
          <p class="text-sm text-gray-500 mb-6">Assignments will appear here when your teachers post them.</p>

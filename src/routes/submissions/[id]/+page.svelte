<script lang="ts">
  ...
  function editExercise() {
    goto(`/exercises/${$page.params.id}/edit`); // Edit stays on exercises route
  }
...
<svelte:head>
  <title>{exercise?.title || 'Exit Ticket'} - IDEA</title>
</svelte:head>
      ...
      <div class="py-3 sm:py-4">
        <div class="flex items-center justify-between gap-3 flex-wrap">
          ...
          {#if exercise && ['TEACHER', 'ADMIN'].includes($authStore.user?.role || '')}
            <Button variant="secondary" size="sm" on:click={editExercise}>
              <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="card overflow-hidden">
        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Exit Ticket Details</h3>
        ...
        <div class="p-6">
          ...
          <div class="mb-8">
            <div class="flex items-center space-x-3 mb-6">
              ...
              <h3 class="text-xl font-semibold text-gray-900">Exit Ticket Content</h3>
            </div>
            ...
            {:else if showEditForm}
              ...
              <div class="bg-gray-50 rounded-lg border border-gray-200 p-6 mt-6">
                <div class="flex items-center space-x-3 mb-6">
                  ...
                  <h4 class="text-xl font-semibold text-gray-900">Edit Your Submission</h4>
                </div>
